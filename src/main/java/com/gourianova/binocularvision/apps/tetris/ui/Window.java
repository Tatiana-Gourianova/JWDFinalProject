package com.gourianova.binocularvision.apps.tetris.ui;

import com.gourianova.binocularvision.apps.tetris.model.Coordinates;
import com.gourianova.binocularvision.apps.tetris.service.PlayFigure;
...
public class Window extends JFrame implements Runnable {
    private final com.gourianova.binocularvision.apps.tetris.ui.Box[][] boxes;
    ...
    public com.gourianova.binocularvision.apps.tetris.ui.Box[][] getBoxes() {
        return boxes;
    }

    public Window() {
        boxes = new com.gourianova.binocularvision.apps.tetris.ui.Box[Config.WIDTH][Config.HEIGHT];
        initForm();
        initBoxes();
    ...
    public void initBoxes() {
        for (int x = 0; x < Config.WIDTH; x++) {
            for (int y = 0; y < Config.HEIGHT; y++) {
                boxes[x][y] = new com.gourianova.binocularvision.apps.tetris.ui.Box(x, y);
                add(boxes[x][y]);
            }
        }
    }
